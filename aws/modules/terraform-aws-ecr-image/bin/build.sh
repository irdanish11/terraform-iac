...
# Connect into aws
aws ecr get-login-password --region $3 --profile $4 | docker login --username AWS --password-stdin $5.dkr.ecr.$3.amazonaws.com || { echo 'ERROR: aws ecr login failed' ; exit 1; }
